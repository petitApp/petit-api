                ...
                <div class="card-body" style="padding-top:0">
                    ...
                    <form method="POST" class="d-flex justifycontent-center flex-column" enctype="multipart/form-data" action="{{ url('/user/create') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="number" class="form-control" name="password" required autofocus>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label text-md-right">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="latitude" type="number" min="1" class="form-control" name="latitude" autofocus>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="longitude" type="number" min="1" class="form-control" name="longitude"  autofocus>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label text-md-right">
